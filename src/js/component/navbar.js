...
import { ButtonGroup, DropdownButton, Dropdown, Navbar, Container, Badge } from "react-bootstrap";
	...
	return (
		<Navbar expand="lg" className="navbar">
			<Container>
				...
				<ButtonGroup>
					<DropdownButton as={ButtonGroup} title="Favorites" id="bg-nested-dropdown">
